...
extern double cp_vec2_sqr_dist(
    cp_vec2_t const* a,
    cp_vec2_t const* b)
{
    cp_vec2_t d[1];
...
extern double cp_vec3_sqr_dist(
    cp_vec3_t const* a,
    cp_vec3_t const* b)
{
    cp_vec3_t d[1];
...
extern double cp_vec4_sqr_dist(
    cp_vec4_t const* a,
    cp_vec4_t const* b)
{
    cp_vec4_t d[1];
